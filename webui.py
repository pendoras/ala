                        ...
                        with gr.Row():
                            ...
                            with gr.Column(visible=modules.config.default_inpaint_advanced_masking_checkbox) as inpaint_mask_generation_col:
                                ...
                                inpaint_mask_cloth_category = gr.Dropdown(label='Cloth category',
                                                             ...
                                                             visible=modules.config.default_inpaint_mask_model == 'u2net_cloth_seg')
                                inpaint_mask_dino_prompt_text = gr.Textbox(label='Detection prompt', value='clothes', visible=modules.config.default_inpaint_mask_model == 'sam', info='Use singular whenever possible', placeholder='Describe what you want to detect.')
                                ...
                                with gr.Accordion("Advanced options", visible=modules.config.default_inpaint_mask_model == 'sam', open=False) as inpaint_mask_advanced_options:
                        ...
                        with gr.Tab(label=f'#{index + 1}') as enhance_tab_item:
                            ...
                            with gr.Accordion("Inpaint", visible=True, open=False):
                                ...
                                enhance_inpaint_respective_field = gr.Slider(label='Inpaint Respective Field',
                                                                             minimum=0.0, maximum=1.0, step=0.001,
                                                                             value=0.0 if modules.config.default_inpaint_method == modules.flags.inpaint_option_modify else 0.618,
